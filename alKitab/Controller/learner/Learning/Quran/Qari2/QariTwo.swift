...
class QariTwo: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{

    @IBOutlet weak var easyQari2CollectionVIew: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        easyQari2CollectionVIew.register(UINib(nibName: "EMHLearningCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "EMHLearningCollectionViewCell")
    }
    
    override func viewWillAppear(_ animated: Bool) {
        super.viewWillAppear(true)
       
        easyQari2CollectionVIew.reloadData()
    }
...
extension QariTwo{
    ...
    func sendToNextController(indexPath: IndexPath){
        ...
        HomeViewController.qariNumber = "(q2)"
